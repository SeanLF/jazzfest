class ReportController < ApplicationController
  ...
  def export_opportunity_applications
    ...
    @opportunity_applications = policy_scope(OpportunityApplication).submitted.eager_load(:profile, :opportunity_application_status)
  ...
  def export_opportunity_application_comments
    ...
    respond_to do |format|
      format.xlsx { response.headers['Content-Disposition'] = 'attachment; filename="Volunteer application comments.xlsx"' }
    end
  end
end
