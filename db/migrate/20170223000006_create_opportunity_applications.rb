class CreateOpportunityApplications < ActiveRecord::Migration[5.0]
  def change
    create_table :opportunity_applications do |t|
      ...
      t.string :choices
      t.boolean :submitted
      t.references :opportunity_application_status, index: { name: 'index_applications_on_application_status_id' }, foreign_key: { to_table: :opportunity_application_status }
